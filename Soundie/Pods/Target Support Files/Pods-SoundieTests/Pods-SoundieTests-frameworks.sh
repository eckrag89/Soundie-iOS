...
install_framework()
{
  local source="${BUILT_PRODUCTS_DIR}/Pods-SoundieTests/$1"
...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework 'ILGHttpConstants.framework'
  install_framework 'VOKBenkode.framework'
  install_framework 'VOKMockUrlProtocol.framework'
fi
